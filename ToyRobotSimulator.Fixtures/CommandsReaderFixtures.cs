...
MOVE";
            ...
            //Act
            string[] commands = commandsReader.GetCommands("dir","filePath");
        ...
        public void GetCommands_NoFile_ThrowsException()
        {
            ...
            //Act and Assert
            ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() => commandsReader.GetCommands("dir", null));
